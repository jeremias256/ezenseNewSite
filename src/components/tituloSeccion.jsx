    ...
    <>
      <div className="title_content flex">
        <div className="tc-c1 w-[32px]">
          <div className="tc-c1-r1 rounded-tl-custom-br555 rounded-bl-custom-br555 h-[58px] border-[2.5px] border-r-0 border-callToAction"></div>
        ...
        <div className="tc-c2">
          ...
          <div className="tc-c2-r2 h-[30px] border-b-[2.5px] border-callToAction"></div>
        </div>
        <div className="tc-c3">
          <div className="tc-c3-r1 h-[34px] w-[45px]">
            <BiselSmall />
          </div>
          <div className="tc-c3-r2 h-[24px] w-[45px] border-b-[2.5px] border-callToAction"></div>
          <div className="tc-c3-r3 h-[30px] border-b-[2.5px] border-callToAction"></div>
        </div>
        <div className="tc-c4 flex-1">
          <div className="tc-c4-r1 mt-[32px] h-[26px] w-full border-b-[2.5px] border-t-[2.5px] border-callToAction"></div>
          <div className="tc-c4-r2 h-[30px] border-b-[2.5px] border-callToAction"></div>
        </div>
