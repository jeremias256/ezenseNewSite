...
const Bureau = () => {
  return (
    <div className="bureau-content absolute z-10 w-full" style={{ top: `5585px` }}>
                ...
                <div className='personas'>
                    ...
                    <div className='persona'> 
                        ...
                        <div className='persona-funcion'>
                            <span className='text-sm-nunito-400 grey-black'> UI/UX Specialist / Partner </span>
                        </div>
                    ...
                    <div className='persona'> 
                        ...
                        <div className='persona-funcion'>
                            <span className='text-sm-nunito-400 grey-black'> Operative Director / Asociated </span>
                        </div>
