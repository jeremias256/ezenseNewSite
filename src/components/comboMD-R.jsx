            ...
            <div className='mdr-combo_content3'>
                ...
                <div className='mdr-cb'>
                    <div className='mdr-cb-f1'>
                        <div className='mdr-cb-f1-f1'></div>
                    </div>
                </div>
                    ...
                    <div className='mdr-ca-f1'>
                        ...
                        <div className='mdr-ca-f1-f2'>
                            ...
                            <div className='mdr-ca-f1-f2-c1'>
                                <div className='mdr-ca-f1-f2-c1-relleno1'></div>
                                <div className='mdr-ca-f1-f2-c1-f1'></div>
                                <div className='mdr-ca-f1-f2-c1-relleno2'></div>
                                <div className='mdr-ca-f1-f2-c1-f2'></div>
                            </div>
                        </div>
                    </div>
