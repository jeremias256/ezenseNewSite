  ...
  return (
    <div className="works_content px-3 py-0 md:mt-[16px] relative">
      <div className="works-back mx-auto w-full max-w-[1440px] ">
        ...
        <div className="grid lg:mt-[46px] lg:px-[90px] lg:grid-cols-[750px_420px] lg:gap-[90px] grid-cols-[1fr] px-[8px] mt-[16px] gap-[16px]">
          <ComboMDR data={['clarin', 'home']} />
          <ComboMD data={['mondelez', 'home']} />
        </div>

        <div className="grid lg:mt-[46px] lg:px-[90px] lg:grid-cols-[1fr_1fr] lg:gap-[90px] grid-cols-[1fr] px-[8px] mt-[16px] gap-[16px] ">
          <ComboMD data={['nissan', 'home']} />
          <ComboMDR data={['cocacola', 'home']} />
        </div>

        <div className="grid lg:mt-[46px] lg:px-[90px] lg:grid-cols-[420px_750px] lg:gap-[90px] grid-cols-[1fr] px-[20px] mt[16px]">
